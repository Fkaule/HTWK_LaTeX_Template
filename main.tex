...
\pagestyle{empty}
\include{00_Deckblatt}			% Deckblatt
\include{00_Aufgabenstellung}
\begin{singlespacing}
\include{00_Inhaltsverzeichnis}	% Inhaltsverzeichnis
\end{singlespacing}
\setcounter{page}{1} 				% Hier mit Seitenzahlen beginnen

% Symbolverzeichnis
\addcontentsline{toc}{chapter}{Symbolverzeichnis}
\include{00_Symbolverzeichnis}	% Symbolverzeichnises
...
\input{03_Material_und_Methoden.tex}
\input{04_Ergebnisse.tex}
\input{05_Diskussion.tex}
\input{06_Zusammenfassung_Ausblick.tex}
...
\include{ANHANG/Beispiel_Anhang.tex}			% Anhang immer nur mit sections!
